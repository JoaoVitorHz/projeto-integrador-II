 ...
 * @author vitor
 */
public class ViewSyntheticReport extends javax.swing.JFrame {

    /**
     * Creates new form ViewSyntheticReport
     */
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Relatório Sintético");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod. Venda", "Produto", "Quantidade", "Valor Unitario", "Nome Cliente", "CPF Cliente", "Data de venda "
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSyntheticReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSyntheticReport().setVisible(true);
            }
        });
    }
